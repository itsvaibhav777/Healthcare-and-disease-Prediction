...
# Load CSV data
sym_des = pd.read_csv("Disease-Prediction-and-Medicine-Recommendation-System\symptoms.csv")
precautions = pd.read_csv("Disease-Prediction-and-Medicine-Recommendation-System\precautions.csv")
workout = pd.read_csv("Disease-Prediction-and-Medicine-Recommendation-System\workout.csv")
description = pd.read_csv("Disease-Prediction-and-Medicine-Recommendation-System\description.csv")
medications = pd.read_csv("Disease-Prediction-and-Medicine-Recommendation-System\medications.csv")
diets = pd.read_csv("Disease-Prediction-and-Medicine-Recommendation-System\diets.csv")

# Load the model
svc = pickle.load(open('Disease-Prediction-and-Medicine-Recommendation-System\svc.pkl', 'rb'))
